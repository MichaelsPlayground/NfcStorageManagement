...
// libsodium cryptobox
// gets the public key from post
// returns the encrypted data and own public key

$data = json_decode(file_get_contents('php://input'), true);
$jsonPublicKey = $data["publickey"];

echo 'LIBSODIUM' . PHP_EOL;
echo $data . PHP_EOL;
echo $jsonPublicKey . PHP_EOL;
...
//$jsonPublicKey = 'jVSuHjVH47PMbMaAxL5ziBS9/Z0HQK6TJLw9X3Jw6yg=';
$publicKeyBBase64 = $jsonPublicKey;
...
// return the ciphertext and own public key
$publicKeyABase64 =  'b+Z6ajj7wI6pKAK5N28Hzp0Lyhv2PvHofwGY3WSm7W0=';
$arr = array('ciphertext' => $ciphertextBase64, 'serverpublickey' => $publicKeyABase64);
